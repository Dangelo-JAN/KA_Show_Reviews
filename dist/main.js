...
eval("\n\nmodule.exports = function (url, options) {\n  if (!options) {\n    options = {};\n  }\n\n  if (!url) {\n    return url;\n  }\n\n  url = String(url.__esModule ? url.default : url); // If url is already wrapped in quotes, remove them\n\n  if (/^['\"].*['\"]$/.test(url)) {\n    url = url.slice(1, -1);\n  }\n\n  if (options.hash) {\n    url += options.hash;\n  } // Should url be wrapped?\n  // See https://drafts.csswg.org/css-values-3/#urls\n\n\n  if (/[\"'() \\t\\n]|(%20)/.test(url) || options.needQuotes) {\n    return \"\\\"\".concat(url.replace(/\"/g, '\\\\\"').replace(/\\n/g, \"\\\\n\"), \"\\\"\");\n  }\n\n  return url;\n};\n\n//# sourceURL=webpack://ka_show_reviews/./node_modules/css-loader/dist/runtime/getUrl.js?");
...
eval("\n\nmodule.exports = function (i) {\n  return i[1];\n};\n\n//# sourceURL=webpack://ka_show_reviews/./node_modules/css-loader/dist/runtime/noSourceMaps.js?");
...
eval("\n\n/* istanbul ignore next  */\nfunction insertStyleElement(options) {\n  var element = document.createElement(\"style\");\n  options.setAttributes(element, options.attributes);\n  options.insert(element, options.options);\n  return element;\n}\n\nmodule.exports = insertStyleElement;\n\n//# sourceURL=webpack://ka_show_reviews/./node_modules/style-loader/dist/runtime/insertStyleElement.js?");
...
eval("\n\n/* istanbul ignore next  */\nfunction setAttributesWithoutAttributes(styleElement) {\n  var nonce =  true ? __webpack_require__.nc : 0;\n\n  if (nonce) {\n    styleElement.setAttribute(\"nonce\", nonce);\n  }\n}\n\nmodule.exports = setAttributesWithoutAttributes;\n\n//# sourceURL=webpack://ka_show_reviews/./node_modules/style-loader/dist/runtime/setAttributesWithoutAttributes.js?");
...
eval("\n\n/* istanbul ignore next  */\nfunction styleTagTransform(css, styleElement) {\n  if (styleElement.styleSheet) {\n    styleElement.styleSheet.cssText = css;\n  } else {\n    while (styleElement.firstChild) {\n      styleElement.removeChild(styleElement.firstChild);\n    }\n\n    styleElement.appendChild(document.createTextNode(css));\n  }\n}\n\nmodule.exports = styleTagTransform;\n\n//# sourceURL=webpack://ka_show_reviews/./node_modules/style-loader/dist/runtime/styleTagTransform.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ GlobalVariables)\n/* harmony export */ });\nclass GlobalVariables {\n  showsLink = document.getElementById('shows-link');\n\n  showList = document.getElementById('show-list');\n\n  popupImage = document.querySelector('.popup-image');\n\n  popupTitle = document.querySelector('.popup-title');\n\n  showDetails1 = document.querySelector('.info-1');\n\n  showDetails2 = document.querySelector('.info-2');\n\n  showDetails3 = document.querySelector('.info-3');\n\n  showDetails4 = document.querySelector('.info-4');\n\n  commentsContainer = document.querySelector('.comments-container');\n\n  inputField = document.querySelector('.input-name');\n\n  commentField = document.querySelector('.comment-details');\n\n  submitButton = document.getElementById('submit');\n\n  commentForm = document.getElementById('comment-form');\n}\n\n//# sourceURL=webpack://ka_show_reviews/./src/modules/global.js?");
...
/******/ 	(() => {
/******/ 		__webpack_require__.p = "/KA_Show_Reviews/";
/******/ 	})();
/******/ 	
